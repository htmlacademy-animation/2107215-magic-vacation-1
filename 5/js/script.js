...
/***/ "./source/js/modules/screen-fill.js":
/*!******************************************!*\
  !*** ./source/js/modules/screen-fill.js ***!
  \******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const menuLinks = document.querySelectorAll(`.js-menu a`);
  const animationTextHistory = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.slider__item-title`, 400, `ease`, `slider__text`, `move-text-span`, 0, 60);
  const animationTextPrizes = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.prizes__title`, 400, `ease`, `prizes__text`, `move-text-span`, 0, 60);
  const animationTextRules = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.rules__title`, 400, `ease`, `rules__text`, `move-text-span`, 0, 60);
  const animationTexIntro = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`, 300, `ease`, `intro__text`, `move-intro-span`, 0, 50);
  const animationTexGame = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.game__title`, 400, `ease`, `game__text`, `move-text-span`, 0, 60);
  const animationIntroDate = new _accent_typography_builder__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__date`, 200, `cubic-bezier(0.32, -0.98, 0, 0.77)`, `intro__text-date`, `move-text-date`, 1250, 40);
...
/* harmony import */ var _modules_screen_load__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/screen-load */ "./source/js/modules/screen-load.js");
/* harmony import */ var _modules_screen_fill__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/screen-fill */ "./source/js/modules/screen-fill.js");
...
Object(_modules_text_animation__WEBPACK_IMPORTED_MODULE_11__["default"])();

const fullPageScroll = new _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_8__["default"]();
fullPageScroll.init();

window.addEventListener(`load`, () => {
  Object(_modules_screen_load__WEBPACK_IMPORTED_MODULE_9__["default"])();
  Object(_modules_screen_fill__WEBPACK_IMPORTED_MODULE_10__["default"])();
});
